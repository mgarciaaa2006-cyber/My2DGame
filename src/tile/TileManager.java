...
public class TileManager{
    ...
    public void getTileImage() {
        try {
            ...
            tile[6] = new Tile();
            tile[6].image = ImageIO.read(getClass().getResourceAsStream("/tile/Dirt.png"));

            tile[7] = new Tile();
            tile[7].image = ImageIO.read(getClass().getResourceAsStream("/tile/Sand.png"));

            tile[8] = new Tile();
            tile[8].image = ImageIO.read(getClass().getResourceAsStream("/tile/Tree.png"));
        }catch(IOException e){
            e.printStackTrace();
        }
    }
